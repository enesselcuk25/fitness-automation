...
namespace spor_salonu_projesi
{
    public partial class kayıt_sayfası : Form
    {
        ...
        {
            if (MessageBox.Show("KAYIT YAPTIKTAN SONRA 25 GÜNLÜK BİR ÜYELİĞİNİZ VAR!! KABUL EDECEKMİSİNİZ... ", "SELÇUK SPOR SALONU", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
            ...
            {
                MessageBox.Show("KAYDETME İŞLEMİ İPTAL EDİLDİ", "SELÇUK SPOR SALONU", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        {
            Giriş_sayfası girs = new Giriş_sayfası();
            girs.Show();
            this.Hide();
